...
namespace AttendanceTracker1.Migrations
{
    ...
    [Migration("20250415014154_AddedTeamAndUserTeam")]
    partial class AddedTeamAndUserTeam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceTracker1.Models.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AttendanceTracker1.Models.User", b =>
                {
                    ...
                    b.Property<string>("SystemUserType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AttendanceTracker1.Models.UserTeam", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AttendanceTracker1.Models.UserTeam", b =>
                {
                    b.HasOne("AttendanceTracker1.Models.Team", "Team")
                        .WithMany("UserTeams")
